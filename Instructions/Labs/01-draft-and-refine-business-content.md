...
1. Select the Copilot icon on the **Home** ribbon to open the Copilot pane.
...
1. Select a paragraph you'd like to improve, then ask Copilot to refine it. For example:
    ...
    `Make the results section more specific by adding example percentage improvements.`

1. Ask Copilot to adjust the tone for your audience:

    `Rewrite the introduction in a more confident, client-facing tone.`
...
1. Select **Researcher** from the agent list.
1. Enter the following prompt:
...
1. Copy the summary and paste it into the **Results** section of your Word document, then ask Copilot in Word to blend it in smoothly:
...
1. Review the image options and select one that fits the slide.
...
1. Select **Get Coaching** in the Copilot pane to review suggestions on tone and clarity.
